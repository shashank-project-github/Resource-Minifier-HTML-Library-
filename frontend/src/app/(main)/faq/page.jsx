                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        ...
                                        What does a resource minifier do?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        ...
                                        A resource minifier makes your CSS, and JavaScript files smaller by removing unnecessary spaces and characters. This helps your website load faster.
                                        </p>
                                    </div>
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        What is video compression, and why is it important?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        Video compression shrinks the file size of your videos, which helps them load faster and use less bandwidth. This is crucial for users with slower internet connections or limited data plans.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                ...
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                            Lazy loading delays the loading of images and videos until they are needed (i.e., when they come into view). This speeds up the initial load time of your webpage and saves bandwidth.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        Will minifying files affect my website’s functionality?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        No, minifying files will not affect the functionality of your website. It only removes unnecessary characters that don’t impact how the code runs.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        Can I choose which images and videos to compress or lazy load?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        Yes, you can select specific images and videos to compress or lazy load according to your needs.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        Is there a quality loss when compressing images and videos?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        Our compressors are designed to reduce file size with minimal loss of quality, so your media will still look good while loading faster.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        Is there a limit to the number of files I can compress or minify?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        There may be a limit depending on the service plan you choose. Please check our pricing page for details on file limits and other features.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
				...
				c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"
                            ...
                            <li className="text-left mb-10">
                                <div className="flex flex-row items-start mb-5">
                                    ...
                                    <div className="bg-gray-100 p-5 px-10 w-full flex items-center">
                                        <h4 className="text-md leading-6 font-medium text-gray-900">
                                        Is there a difference between lossy and lossless compression?
                                        </h4>
                                    </div>
                                </div>
                                <div className="flex flex-row items-start">
                                    <div className="bg-indigo-100 p-5 px-10 w-full flex items-center">
                                        <p className="text-gray-700 text-sm">
                                        Yes, lossy compression reduces file size by removing some data, which can slightly affect quality. Lossless compression reduces file size without losing any data, preserving the original quality.
                                        </p>
                                    </div>
                                    <div className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                                        <svg
